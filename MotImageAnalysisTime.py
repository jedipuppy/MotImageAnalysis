...
class ImageAnalysis():
    def __init__(self,filename,start_number2,stop_number2,background_file_number,start_number,stop_number,x,x2,y,y2):
        ...
        self.y =y
        self.y2 = y2
        self.start_number2 = start_number2
        self.stop_number2 = stop_number2
